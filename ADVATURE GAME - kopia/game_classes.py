...
class Player:
    ...
    def level_up(self) -> None:
        ...
        """
        self.player_armor += self.p_turn
        self.player_damage += self.p_turn
        self.player_hp += self.p_turn
